...
def ready(unoptimized_dir: str, optimized_dir: str):
    unoptimized_dir = Path("OliveCache") / unoptimized_dir
    optimized_dir = Path("ONNX-Olive") / optimized_dir
...
def optimize(
    ...
    *olive_merge_lora_inputs,
    ...
    os.environ["OLIVE_LORA_BASE_PATH"] = str(Path("Lora"))
    if olive_merge_lora:
...
def optimize_sd_from_ckpt(
    checkpoint: str,
    vae_id: Optional[str] = "",
    vae_subfolder: Optional[str]  = "",
    unoptimized_dir: Optional[str]  = "",
    optimized_dir: Optional[str]  = "",
    safety_checker: bool = True,
    text_encoder: bool = True,
    unet: bool = True,
    vae_decoder: bool = True,
    vae_encoder: bool = True,
    scheduler_type: str = "euler",
    use_fp16: bool = True,
    sample_size: Union[Tuple[int, int], int] = 512,
    olive_merge_lora: bool = False,
    *olive_merge_lora_inputs,
):
